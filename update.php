...
//it handles all operation of user side chossing answers and update answer of quiz in database etc.....
...
//below is for delete quiz,delete user and enable and disable quiz from admin side that done but unaffected at database if this is not working.and also doing lock answers at user side working and affected at database side.
